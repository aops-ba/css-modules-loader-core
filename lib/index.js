...
var Core = (function () {
  ...
  _createClass(Core, [{
    ...
    value: function load(sourceString, sourcePath, trace, pathFetcher) {
      ...
      var fromPath = "/" + sourcePath;
      if (sourcePath[1] === ":" && sourcePath[2] === "\\") {
        fromPath = sourcePath;
      }

      return (0, _postcss2['default'])(this.plugins.concat([parser.plugin])).process(sourceString, { from: fromPath }).then(function (result) {
